...
namespace NexumTech.Domain.Services
{
    public class MailMessageService : IMailMessageService
    {
        ...
        private string PasswordResetMessage(UserViewModel user)
        {
            ...
            message.Append(_localizer["PasswordRecovery"]);
            message.Append("</div>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("<tr>");
            ...
            message.Append(_localizer["ClickButton"]);
            message.Append("</div>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("<tr>");
            ...
            message.Append(_localizer["ResetPassword"]);
            message.Append("</a>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("</table>");
            ...
            message.Append(_localizer["Ignore"]);
            message.Append("</div>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("</table>");
            ...
            message.Append("São Bernardo do Campo, São Paulo, Brasil");
            message.Append("</div>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("</table>");
        ...
        private string RegisterMessage(UserViewModel user)
        {
            ...
            message.Append("<td align=\"center\" style=\"font-size:0px;padding:10px 25px;padding-bottom:20px;word-break:break-word;padding-top:28px;\">");
            message.Append("<div style=\"font-family:'Helvetica Neue',Arial,sans-serif;font-size:28px;font-weight:bold;line-height:1;text-align:center;color:#555;\">");
            message.Append(_localizer["Welcome"]);
            message.Append("</div>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("<tr>");
            ...
            message.Append("<div style=\"font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;\">");
            message.Append(_localizer["Start"]);
            message.Append("</div>");
            message.Append("</td>");
            message.Append("</tr>");
            message.Append("</table>");
